...
covidAfrica <- readRDS("covidAfrica.RDS")
```
...
highchart() %>%
  hc_add_series_map(worldgeojson, countries, value = 'log_total_confirmed', joinBy = c('name','country'))  %>% 
  hc_colors(c("darkorange", "darkgray")) %>% 
  hc_colorAxis(stops = color_stops()) %>% 
  hc_title(text = "Les Pays exposés au COVID19 en AFRIQUE") %>% 
  hc_subtitle(text = 'Avec les cas confirmés') 
```
...
highchart() %>%
  hc_add_series_map(africa_map, countries, value = 'total_confirmed', joinBy = c('name','country'))  %>% 
  #hc_colors(c("darkorange", "darkgray")) %>% 
  hc_colorAxis(stops = color_stops()) %>% 
...
highchart() %>%
  hc_add_series_map(africa_map, countries, value = 'total_recovered', joinBy = c('name','country'))  %>% 
  #hc_colors(c("darkorange", "darkgray")) %>% 
  hc_colorAxis(stops = color_stops()) %>% 
  hc_title(text = "Pays exposés au COVID19") %>% 
...
highchart() %>%
  hc_add_series_map(africa_map, countries, value = 'total_deaths', joinBy = c('name','country'))  %>% 
  #hc_colors(c("darkorange", "darkgray")) %>% 
  hc_colorAxis(stops = color_stops()) %>% 
  hc_title(text = "Pays exposés au COVID19") %>% 
...
<center>
    <a href="mailto:ayao.nomenyo12@gmail.com"> Ecrivez-nous <a>
<center>